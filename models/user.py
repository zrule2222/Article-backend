...
class UserModel(db.Model):
    ...
    def __init__(self, username, password,created_at = func.now(),updated_at = func.now()):
    ...
    def __repr__(self):
        return 'UserModel(username=%s, password=%s,author_id=%s,created_at=%s,updated_at=%s)' % (self.username, self.password,self.created_at,self.updated_at)

    def json(self):
        return {'username': self.username, 'password': self.password, 'created_at': self.created_at, 'updated_at': self.updated_at}
